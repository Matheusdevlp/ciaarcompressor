package com.admincompressor.ciaarcompressor.services;
...
import com.admincompressor.ciaarcompressor.domain.Chamado;
import com.admincompressor.ciaarcompressor.domain.Cliente;
import com.admincompressor.ciaarcompressor.domain.Tecnico;
import com.admincompressor.ciaarcompressor.domain.enums.Perfil;
import com.admincompressor.ciaarcompressor.domain.enums.Prioridade;
import com.admincompressor.ciaarcompressor.domain.enums.Status;
import com.admincompressor.ciaarcompressor.repositories.ChamadoRepository;
import com.admincompressor.ciaarcompressor.repositories.PessoaRepository;
...
public class DBService {
		...
		public void instanciaDB() {
			...
			Tecnico tec6 = new Tecnico(null, "Matheus Phelipe", "522.617.188-96", "matheusphelipe3131@mail.com", encoder.encode("123"));
